...
```{r sampleSheet}
# CaronBourque2020
cb_sampleSheetFn <- file.path(projDir,
			      "Data/CaronBourque2020/SraRunTable.txt")
# Human Cell Atlas
hca_sampleSheetFn <- file.path(projDir,
			       "Data/Hca/accList_Hca.txt")
...
sampleSheet <- rbind(cb_sampleSheet[,splShtColToKeep],
		     hca_sampleSheet[,splShtColToKeep])
...
tmpFn <- sprintf("%s/Images/tenxLibStructureV3.png", projDir)
...
#if(!FALSE) # slow, but needs running at least once
