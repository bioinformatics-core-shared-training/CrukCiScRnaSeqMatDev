...
projDirBookRel <- params$projDirBookRel
#projDirScriptsRel <- params$projDirScriptsRel
...
```{r}
print(sprintf("%s/%s/%s", projDir, outDirBit, qcPlotDirBit))
#knit_exit()
```
...
#tmpFn <- sprintf("%s/Images/tenxLibStructureV3.png", projDirScriptsRel)
tmpFn <- sprintf("%s/Images/tenxLibStructureV3.png", "..")
#tmpFn <- "Images/tenxLibStructureV3.png"
print(getwd())
print(tmpFn)
print(file.exists(tmpFn))
```
...
```{r qc_metricDistrib_plotColData_show, out.width="80%", eval=TRUE}
