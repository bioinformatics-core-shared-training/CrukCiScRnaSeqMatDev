...
```{r dataSetIntegration_HHD_setup, include=FALSE, echo=FALSE, dev="CairoPNG"}
...
```{r, fig.height=figSize*length(gxList)*2/3, fig.width=figSize}
...
```{r save_mnnout_dataSetIntegration_HHD}
# save object?
...
```{r sessionInfo_dataSetIntegration_HHD}
sessionInfo()
```
