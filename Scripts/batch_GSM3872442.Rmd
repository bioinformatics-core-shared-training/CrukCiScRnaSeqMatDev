...
```{r batch_GSM3872442.knitr_options, include=FALSE, echo=FALSE}
...
```{r libSizeBatchSct_back_batch_GSM3872442}
sce <- sceOrig
```

Some cells are very different from the rest.

```{r libSizeBatchSct_sctransform_vst_batch_GSM3872442}
counts <- counts(sce)
colnames(counts) <- colData(sce)$Barcode
...
```{r libSizeBatchSct_vst_batch_GSM3872442}
...
```{r libSizeBatchSct_model_batch_GSM3872442}
...
```{r libSizeBatchSct_subsetGenes_batch_GSM3872442}
# exclude genes that were not used in the transformation: 
...
```{r libSizeBatchSct_copyVstMat_batch_GSM3872442}
...
```{r libSizeBatchSct_modelPars_batch_GSM3872442}
...
```{r libSizeBatchSct_pca_batch_GSM3872442}
...
```{r libSizeBatchSct_tsne_batch_GSM3872442}
...
```{r libSizeBatchSct_umap_batch_GSM3872442}
...
```{r libSizeBatchSct_addBatchOnly_batch_GSM3872442}
...
```{r libSizeBatchSct_copy_batch_GSM3872442}
scePostSct <- sce
```
