...
```{r norm_GSM3872434.knitr_options, echo=FALSE, results="hide", message=FALSE}
...
```{r plot_rle_sct_GSM3872434_allCells}
p <- plotRLE(
    sce,
...
```{r show_rle_sct_GSM3872434_allCells, cache.lazy = FALSE}
tmpFn <- sprintf("%s/%s/%s_sce_nz_postQc%s_%sRle.png",
                 dirRel, normPlotDirBit, setName, setSuf, typeNorm)
knitr::include_graphics(tmpFn, auto_pdf = TRUE)
rm(tmpFn)
