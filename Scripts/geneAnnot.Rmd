...
```{r geneAnnot.knitr_options, echo=FALSE, results="hide", message=FALSE}
...
```{r geneAnnot_raw_annot, eval=biomartBool}
...
```{r geneAnnot_writeRds, eval=biomartBool}
# slow
...
```{r geneAnnot_readRds, eval=!biomartBool}
# Read object in:
tmpFn <- sprintf("%s/%s/Robjects/sceRaw_postBiomart.Rds", projDir, outDirBit)
