...
```{r doubletDetect_setup, include=FALSE, echo=FALSE, dev="CairoPNG"}
...
```{r library_doubletDetect, message=FALSE}
library(ggplot2)
...
```{r tsne_plotCluster_doubletDetect}
...
```{r computeDoubletDensity_doubletDetect}
set.seed(100)
...
```{r tsne_plotDoubletScore_doubletDetect}
...
```{r violin_plotDoubletScore_doubletDetect}
