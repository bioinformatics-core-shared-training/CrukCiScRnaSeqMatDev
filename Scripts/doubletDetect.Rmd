...
```{r doubletDetect_setup, include=FALSE, echo=FALSE}
...
We also plot the t-SNE showing clusters, which are not used for the doublet detection by simulation used here, but help visualise cells with different expression profiles.
