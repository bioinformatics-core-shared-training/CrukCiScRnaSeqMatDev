...
```{r cellCyclePhases_setup, include=FALSE, echo=FALSE}
...
tsne1b <- plotTSNE(mnn.out, colour_by="phases", by_exprs_values = "reconstructed") + fontsize
umap1b <- plotUMAP(mnn.out, colour_by="phases", by_exprs_values = "reconstructed") + fontsize
