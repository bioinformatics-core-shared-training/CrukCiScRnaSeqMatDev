...
```{r setup_dsi_PBMMC_ETV6-RUNX1, include=FALSE, echo=FALSE, dev="CairoPNG"}
options(bitmapType='cairo')
knitr::opts_chunk$set(dev="CairoPNG")
```

```{r variables_dsi_PBMMC_ETV6-RUNX1}
...
```{r libraries_dsi_PBMMC_ETV6-RUNX1}
library(knitr)
```

```{r knit_expand_dsi_PBMMC_ETV6-RUNX1, include=TRUE, eval=TRUE}
isChild <- "yes" # TRUE
