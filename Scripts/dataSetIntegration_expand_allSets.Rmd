...
```{r setup_dsi_allSets, include=FALSE, echo=FALSE, dev="CairoPNG"}
options(bitmapType='cairo')
knitr::opts_chunk$set(dev="CairoPNG")
```

```{r variables_dsi_allSets}
...
```{r libraries_dsi_allSets}
library(knitr)
```

```{r knit_expand_dsi_allSets, include=TRUE, eval=TRUE}
isChild <- "yes" # TRUE
