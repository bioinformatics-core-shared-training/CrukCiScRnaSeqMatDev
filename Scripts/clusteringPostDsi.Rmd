...
# Clustering with '`r sprintf("'%s'", splSetToGet)`' and '`r setSuf`' {#clustering`r anaStg`Top}
...
```{r exprKnownMarkers_plot1_clusteringPostDsi, fig.height=6, fig.width=8}
...
Add clusters to initial sce (not the output fastMNN)
