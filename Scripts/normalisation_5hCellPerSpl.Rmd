...
```{r norm_{{setNameUpp}}.knitr_options, echo=FALSE, results="hide", message=FALSE}
...
# Normalisation - `r "{{setNameUpp}}"` set
...
```{r normalisation_5hCellPerSpl_{{setNameUpp}}_readIn, cache.lazy = FALSE}
setSuf <- ""
