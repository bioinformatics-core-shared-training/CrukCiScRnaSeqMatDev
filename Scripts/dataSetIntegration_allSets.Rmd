...
```{r dataSetIntegration_allSets_setup, include=FALSE, echo=FALSE}
...
# Data integration {#dataSetIntegration_allSetsTop}
...
```{r}
nSteps <- 4 # waltrap default
if(ncol(uncorrected)>10000){nSteps <- 20} # or else get 63 clusters with caron allCells
library(scran)
