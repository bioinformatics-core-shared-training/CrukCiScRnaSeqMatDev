...
```{r preProcAllCells.knitr_options, echo=FALSE, results="hide", message=FALSE}
...
```{r corelLibSizePropCellExpress_show, out.width="80%", eval=FALSE}
getwd()
...
```{r qc_metricDistrib_plotColData_show, out.width="80%", eval=FALSE}
...
```{r qc_metricDistrib_plotColDataBatch_show, out.width="80%", eval=FALSE}
...
tmpFn <- sprintf("../%s/%s_sparsity%s.png", qcPlotDirBit, setName, setSuf)
knitr::include_graphics(tmpFn, auto_pdf = TRUE)
rm(tmpFn)
```
