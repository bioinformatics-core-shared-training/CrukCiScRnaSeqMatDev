...
```
##              used    (Mb)  gc trigger     (Mb)    max used     (Mb)
## Ncells    8727036   466.1    17337724    926.0    17337724    926.0
## Vcells 1485193693 11331.2 13550558216 103382.6 16938196043 129228.2
```
...
##   [3] crosstalk_1.1.1           BiocParallel_1.24.1      
