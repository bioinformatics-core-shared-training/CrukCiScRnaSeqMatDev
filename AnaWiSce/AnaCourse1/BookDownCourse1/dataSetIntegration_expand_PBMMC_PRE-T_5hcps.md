...
# Data integration - PBMMC and PRE-T {#dsi-5hCellPerSpl-PBMMC-PRE-TTop}
...
We next subset the data for the PBMMC,PRE-T sample group.
...
* The size of this common “universe” of features here is the number of features shared by all 5 samples is: 16629.
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/diagPlotDraw_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/diagTsnePlot1_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/diagTsnePlotSplit_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/linReg_diagPlotDraw_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/linReg_diagTsnePlot1_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/linReg_diagTsnePlotSplit_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
## rownames(8306): ENSG00000000003 ENSG00000000938 ... ENSG00000285476
##   ENSG00000285486
...
The `corrected` matrix in the `reducedDims()` contains the low-dimensional corrected coordinates for all cells, which we will use in place of the PCs in our downstream analyses (2500 cells and 50 PCs).

A `reconstructed` matrix in the `assays()` contains the corrected expression values for each gene in each cell, obtained by projecting the low-dimensional coordinates in corrected back into gene expression space (8306 genes and 2500 cells). We do not recommend using this for anything other than visualization.
...
##                          [,1]          [,2]          [,3]
## ENSG00000000003  0.0003515637  0.0009463813  0.0002981486
## ENSG00000000938  0.0018417134 -0.0002673390  0.0018540999
## ENSG00000001084  0.0003520712  0.0001819484  0.0029854173
## ENSG00000001167 -0.0015287486 -0.0005886259  0.0018560418
## ENSG00000001460  0.0004878241  0.0004399744  0.0003522270
```
...
```
##        Batch
## Cluster GSM3872440 GSM3872441 GSM3872442 GSM3872443 GSM3872444
##      1           0          1          0        125         11
##      2         207        267         63         14         19
##      3           2         30         31         52         83
##      4           0          9          1         33          8
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/fastmnn_diagPlotDrawSampleName_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/fastmnn_diagPlotDrawSampleType_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
##     GSM3872440 GSM3872441 GSM3872442 GSM3872443 GSM3872444       var
##      <integer>  <integer>  <integer>  <integer>  <integer> <numeric>
## 2          207        267         63         14         19      2.61
## 1            0          1          0        125         11      2.58
## 10           0          0         64         19         93      2.47
## 7          131         35          7          7          1      2.19
## 12           6         61        184        123        127      2.04
## ...        ...        ...        ...        ...        ...       ...
## 6            4         19         15         53         52      0.86
## 4            0          9          1         33          8      0.70
## 11           6         34         20         28         34      0.37
## 5            0          6          2         19          5      0.34
## 13           0          2         12         15          8      0.32
```
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/fastmnn_diagTsnePlot1_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/fastmnn_diagTsnePlot2_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
## [1,]       0.00       0.00       0.00       0.06       0.03
## [2,]       0.00       0.00       0.05       0.02       0.02
## [3,]       0.00       0.14       0.02       0.02       0.02
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/fastmnn_diagTsneClu_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/fastmnn_diagTsneCluBySampleName_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
#```{r fastmnn_diagTsneB_dsi_5hCellPerSpl_PBMMC_PRE-T}
genex <- ensToShow[1]
...
#```{r fastmnn_diagTsneT_dsi_5hCellPerSpl_PBMMC_PRE-T}
genex <- ensToShow[3]
p <- plotTSNE(mnn.out, colour_by = genex, by_exprs_values="reconstructed")
p <- p + ggtitle(
		paste("T cells", genex,
...
#```{r fastmnn_diagTsneM_dsi_5hCellPerSpl_PBMMC_PRE-T}
genex <- ensToShow[2]
p <- plotTSNE(mnn.out, colour_by = genex, by_exprs_values="reconstructed")
p <- p + ggtitle(
...
#```{r fastmnn_diagTsneE_dsi_5hCellPerSpl_PBMMC_PRE-T}
genex <- ensToShow[4]
p <- plotTSNE(mnn.out, colour_by = genex, by_exprs_values="reconstructed")
p <- p + ggtitle(
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/fastmnn_diagTsneCellTypeMarkerShow_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
#```{r uncorr_diagTsneT_dsi_5hCellPerSpl_PBMMC_PRE-T}
genex <- ensToShow[3]
p <- plotTSNE(uncorrected, colour_by = genex)
p <- p + ggtitle(
		paste("T cells", genex,
...
#```{r uncorr_diagTsneM_dsi_5hCellPerSpl_PBMMC_PRE-T}
genex <- ensToShow[2]
p <- plotTSNE(uncorrected, colour_by = genex)
p <- p + ggtitle(
		paste("monocytes", genex,
...
#```{r uncorr_diagTsneE_dsi_5hCellPerSpl_PBMMC_PRE-T}
genex <- ensToShow[4]
p <- plotTSNE(uncorrected, colour_by = genex)
p <- p + ggtitle(
		paste("erythrocytes", genex,
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/uncorr_diagTsneCellTypeMarkerShow_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/biolHet_plotShowHeatmap_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/coasProb_plot_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/randIndex_plot_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
The total number of genes selected in this manner is: 472.
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/consis_plotTsne_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/consis_plotTsneBySampleType_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/consis_plotTsneByBatch_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/consis_plotTsneCluBySample_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
Expression level for the top gene, ENSG00000109475 on violin plots:
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/consis_uncorr_topGene_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />

Expression level for the top gene, ENSG00000109475 on t-SNE plot:
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/consis_uncorr_tsneWoEncour_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/consis_uncorr_tsneWiEncour_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/idPbmmcClu_barPlotDescSize_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/idPbmmcClu_barPlotDescPropPbmmc_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/idPbmmcClu_barPlotPropPbmmcThd050_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/idPbmmcClu_barPlotPropPbmmcTsneThd050_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/idPbmmcClu_barPlotPropPbmmcThd080_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/idPbmmcClu_barPlotPropPbmmcTsneThd080_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/idPbmmcClu_barPlotPropPbmmcTsneThd050CellTypeMarkers_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" /><img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/idPbmmcClu_barPlotPropPbmmcTsneThd050CellTypeMarkers_dsi_5hCellPerSpl_PBMMC_PRE-T-2.png" width="672" /><img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/idPbmmcClu_barPlotPropPbmmcTsneThd050CellTypeMarkers_dsi_5hCellPerSpl_PBMMC_PRE-T-3.png" width="672" /><img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/idPbmmcClu_barPlotPropPbmmcTsneThd050CellTypeMarkers_dsi_5hCellPerSpl_PBMMC_PRE-T-4.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/idPbmmcClu_select_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_5hcps_files/figure-html/idPbmmcClu_barPlotPropPbmmcTsneSelec_dsi_5hCellPerSpl_PBMMC_PRE-T-1.png" width="672" />
