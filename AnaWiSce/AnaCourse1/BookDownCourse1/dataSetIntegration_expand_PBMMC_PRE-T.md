...
# Data integration - PBMMC and PRE-T {#dsi-allCells-PBMMC-PRE-TTop}
...
* The size of this common “universe” of features here is the number of features shared by all 5 samples is: 18431.
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/diagPlotDraw_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/diagTsnePlot1_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/diagTsnePlotSplit_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/linReg_diagPlotDraw_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/linReg_diagTsnePlot1_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/linReg_diagTsnePlotSplit_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
## rownames(10667): ENSG00000000003 ENSG00000000457 ... ENSG00000285476
##   ENSG00000285492
...
The `corrected` matrix in the `reducedDims()` contains the low-dimensional corrected coordinates for all cells, which we will use in place of the PCs in our downstream analyses (18354 cells and 50 PCs).

A `reconstructed` matrix in the `assays()` contains the corrected expression values for each gene in each cell, obtained by projecting the low-dimensional coordinates in corrected back into gene expression space (10667 genes and 18354 cells). We do not recommend using this for anything other than visualization.
...
##                          [,1]          [,2]          [,3]
## ENSG00000000003 -0.0001990647 -0.0002412507 -0.0003968156
## ENSG00000000457  0.0007994390  0.0004146426  0.0001246310
## ENSG00000000938 -0.0014870827  0.0004441514 -0.0021280725
## ENSG00000001167  0.0007179100  0.0007794022  0.0001463194
## ENSG00000001461 -0.0003139926 -0.0005850427 -0.0006295321
```
...
##      9         246       1101          4         10         10
##      10          1         14         27         90         27
##      11         24        114         62        423        397
##      12        528         59          3          5          5
##      13          3          3          3        390         39
##      14          3        188        127        238        501
##      15          1          6        380        199        770
##      16          0         18          2        134         26
##      17         25        374        616       1135        981
##      18          0          0          0         36         10
##      19          1         12          4         10         18
##      20          1         14          0        552         10
##      21        859        175         14         22          9
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/fastmnn_diagPlotDrawSampleName_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/fastmnn_diagPlotDrawSampleType_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
## 15           1          6        380        199        770      8.27
## 9          246       1101          4         10         10      7.73
## 4            1          0        268         74        234      6.31
## 21         859        175         14         22          9      5.35
## 12         528         59          3          5          5      5.16
## ...        ...        ...        ...        ...        ...       ...
## 7            3         13          2         38         62      1.02
## 25           0          4          6         55         18      0.85
## 18           0          0          0         36         10      0.74
## 23           0         12         11         22         15      0.39
## 19           1         12          4         10         18      0.22
```
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/fastmnn_diagTsnePlot1_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/fastmnn_diagTsnePlot2_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
## [1,]       0.00        0.0       0.00       0.06       0.03
## [2,]       0.00        0.0       0.06       0.17       0.05
## [3,]       0.00        0.1       0.00       0.01       0.01
## [4,]       0.05        0.0       0.00       0.00       0.00
```
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/fastmnn_diagTsneClu_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/fastmnn_diagTsneCluBySampleName_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
#```{r fastmnn_diagTsneB_dsi_allCells_PBMMC_PRE-T}
genex <- ensToShow[1]
...
#```{r fastmnn_diagTsneT_dsi_allCells_PBMMC_PRE-T}
genex <- ensToShow[3]
p <- plotTSNE(mnn.out, colour_by = genex, by_exprs_values="reconstructed")
p <- p + ggtitle(
		paste("T cells", genex,
...
#```{r fastmnn_diagTsneM_dsi_allCells_PBMMC_PRE-T}
genex <- ensToShow[2]
p <- plotTSNE(mnn.out, colour_by = genex, by_exprs_values="reconstructed")
p <- p + ggtitle(
...
#```{r fastmnn_diagTsneE_dsi_allCells_PBMMC_PRE-T}
genex <- ensToShow[4]
p <- plotTSNE(mnn.out, colour_by = genex, by_exprs_values="reconstructed")
p <- p + ggtitle(
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/fastmnn_diagTsneCellTypeMarkerShow_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
#```{r uncorr_diagTsneT_dsi_allCells_PBMMC_PRE-T}
genex <- ensToShow[3]
p <- plotTSNE(uncorrected, colour_by = genex)
p <- p + ggtitle(
		paste("T cells", genex,
...
#```{r uncorr_diagTsneM_dsi_allCells_PBMMC_PRE-T}
genex <- ensToShow[2]
p <- plotTSNE(uncorrected, colour_by = genex)
p <- p + ggtitle(
		paste("monocytes", genex,
...
#```{r uncorr_diagTsneE_dsi_allCells_PBMMC_PRE-T}
genex <- ensToShow[4]
p <- plotTSNE(uncorrected, colour_by = genex)
p <- p + ggtitle(
		paste("erythrocytes", genex,
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/uncorr_diagTsneCellTypeMarkerShow_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/biolHet_plotShowHeatmap_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/coasProb_plot_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/randIndex_plot_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
The total number of genes selected in this manner is: 903.
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/consis_plotTsne_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/consis_plotTsneBySampleType_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/consis_plotTsneByBatch_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/consis_plotTsneCluBySample_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
Expression level for the top gene, ENSG00000166710 on violin plots:
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/consis_uncorr_topGene_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />

Expression level for the top gene, ENSG00000166710 on t-SNE plot:
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/consis_uncorr_tsneWoEncour_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/consis_uncorr_tsneWiEncour_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/idPbmmcClu_barPlotDescSize_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/idPbmmcClu_barPlotDescPropPbmmc_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/idPbmmcClu_barPlotPropPbmmcThd050_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/idPbmmcClu_barPlotPropPbmmcTsneThd050_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/idPbmmcClu_barPlotPropPbmmcThd080_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/idPbmmcClu_barPlotPropPbmmcTsneThd080_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/idPbmmcClu_barPlotPropPbmmcTsneThd050CellTypeMarkers_dsi_allCells_PBMMC_PRE-T-1.png" width="672" /><img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/idPbmmcClu_barPlotPropPbmmcTsneThd050CellTypeMarkers_dsi_allCells_PBMMC_PRE-T-2.png" width="672" /><img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/idPbmmcClu_barPlotPropPbmmcTsneThd050CellTypeMarkers_dsi_allCells_PBMMC_PRE-T-3.png" width="672" /><img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/idPbmmcClu_barPlotPropPbmmcTsneThd050CellTypeMarkers_dsi_allCells_PBMMC_PRE-T-4.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/idPbmmcClu_select_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
<img src="dataSetIntegration_expand_PBMMC_PRE-T_files/figure-html/idPbmmcClu_barPlotPropPbmmcTsneSelec_dsi_allCells_PBMMC_PRE-T-1.png" width="672" />
...
## [59] gridExtra_2.3             sass_0.4.0               
## [61] stringi_1.6.1             highr_0.9                
## [63] rlang_0.4.11              pkgconfig_2.0.3          
## [65] bitops_1.0-7              evaluate_0.14            
## [67] lattice_0.20-44           labeling_0.4.2           
## [69] cowplot_1.1.1             tidyselect_1.1.1         
## [71] magrittr_2.0.1            bookdown_0.22            
## [73] R6_2.5.0                  generics_0.1.0           
## [75] DelayedArray_0.16.3       DBI_1.1.1                
## [77] pillar_1.6.1              haven_2.4.1              
## [79] withr_2.4.2               RCurl_1.98-1.3           
## [81] modelr_0.1.8              crayon_1.4.1             
## [83] utf8_1.2.1                rmarkdown_2.8            
## [85] viridis_0.6.1             locfit_1.5-9.4           
## [87] grid_4.0.3                readxl_1.3.1             
## [89] reprex_2.0.0              digest_0.6.27            
## [91] munsell_0.5.0             beeswarm_0.3.1           
